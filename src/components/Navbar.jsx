...
const Navbar = () => {
  return (
    ...
    <section class='py-2 bg-[#007bff] text-white text-right px-10'>
      <p class='text-sm'><strong class="mx-3 text-2xl">Tarakti bharakti News:</strong></p>
    </section>
  
    <div class='flex flex-wrap items-center justify-between gap-4 px-10 py-4 bg-white min-h-[70px]'>
      <a href="javascript:void(0)" className='text-3xl font-semibold font-serif text-blue-600'> Abhi-Tak-News 
      </a>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Business</a>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Entertainment</a>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>World</a>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Sports</a>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>About us</a>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
